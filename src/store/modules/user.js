...
const mutations = {
  SET_GROUPNAMENS: (state, groupNames) => {
...
const actions = {
  ...
  LoginByUsername({commit}, userInfo) {
    ...
    return new Promise((resolve, reject) => {
      loginByUsername(username, userInfo.password, userInfo.tenantId).then(response => {
        const data = response;
  ...
  GetInfo({commit}) {
    return new Promise((resolve, reject) => {
      getInfo().then(response => {
        ...
        commit('SET_GROUPNAMENS', data.groupNames);
        commit('SET_CODE', data.no);
