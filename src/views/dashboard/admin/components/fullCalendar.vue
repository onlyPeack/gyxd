        ...
        <div class="dates-bg">
          <div class="week-row" v-for="week in currentDates">
            <div class="day-cell" v-for="day in week"
              ...
              <!--<div class="number_color red"></div>-->
            </div>
          </div>
        </div>
...
<script type="text/babel">
  ...
  import dateFunc from '@/components/Calendar/components/dateFunc'
  import moment from 'moment';
  import EventCard from '@/components/Calendar/components/eventCard.vue';
  import Header from '@/components/Calendar/components/header.vue';
