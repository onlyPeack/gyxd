  ...
  <div class="register-container pull-height">
    ...
    <div class="register-border animated fadeInRight">
      <div class="register-main">
        <h2 class="register-title" v-if="registerVisible"> 忘记密码 </h2>
...
<script>
  import {addObj, registerCheckMobile, registerCheckUserName, sendRegisterSms, sendForgetSms} from "@/api/admin/company";
  import {forgetPassword} from "@/api/admin/user/index";
  ...
  export default {
    ...
    methods: {
      ...
      handleSendRegisterSms() {
        sendForgetSms(this.dataForm.mobile).then((res) => {
          //验证码发送成功
          if (res.code === 2000) {
      ...
      checkUserName() {
        this.isLoading =true;
        forgetPassword(this.dataForm.phoneCode,this.dataForm.mobile,this.dataForm.password).then(res => {
          console.log(res)
          if(res.code=='2000'){
