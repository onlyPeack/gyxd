...
<el-tree
  ...
  <div>
     <div class="filter-container">
      <el-input @keyup.enter.native="handleDictValueFilter" style="width: 200px;" class="filter-item" placeholder="默认显示" v-model="listDictValueQuery.labelDefault"> </el-input>
       <el-input @keyup.enter.native="handleDictValueFilter" style="width: 200px;" class="filter-item" placeholder="值" v-model="listDictValueQuery.value"> </el-input>
