<template>
  <el-dialog :visible.sync="dialogFormVisible" width="70%" @close="handleClose" class="contractDialog"
             :close-on-click-modal="false" :before-close="handleClose">
      <span slot="title" class="con-title">
        <svg-icon icon-class="contract"></svg-icon>
        <span v-if="!dataForm.billNo">新增其它入库单</span>
        <span v-if="dataForm.billNo">编辑其它入库单</span>
