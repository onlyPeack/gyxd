<template>
  <el-dialog :visible.sync="dialogFormVisible" width="70%" @close="handleClose"
    ...
    <div class="center-container">
      ...
      <el-form :model="dataForm" :rules="rules" ref="dataForm">
        <table class="topTable">
          <tr>
            <td width="50%">
              <el-form-item label="外借日期:" prop="billDate" class="el-form-flex">
                {{dataForm.billDate}}
              </el-form-item>
            </td>
            <td width="50%">
    ...
    <el-table :data="items" border highlight-current-row width="100%" :height="clientHeight"
      ...
      <el-table-column prop="warehouseName" label="外借仓库" width="200" align="left">
...
<script>
  ...
  import {addBill, getBill, tempAddBill, auditBill} from '@/api/erp/wms/bill/borrowStock';
