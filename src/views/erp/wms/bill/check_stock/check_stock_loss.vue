<template>
  <div class="full-purchase bill-container">
    ...
    <div class="filter-container">
      ...
      <div class="query-container">
        <div v-if="choose">
          ...
          <el-input clearable class="filter-item" style="width: 200px;" placeholder="出库仓位"
    ...
    <el-table :data="list" border style="width: 100%" v-loading="listLoading" ref="dataTable"
      ...
      <el-table-column prop="positionName" label="出库仓位" align="center" width="200">
      </el-table-column>
      <el-table-column prop="skuNo" label="商品编码" width="200">
      </el-table-column>
      ...
      <el-table-column prop="qty" label="出库数量" align="right" width="150" class-name="col-required">
      </el-table-column>
      <el-table-column prop="mainDTO.printCount" label="打印次数" width="150" align="right">
      </el-table-column>
      <el-table-column prop="mainDTO.billDate" label="出库日期" width="150" align="center">
      </el-table-column>
    </el-table>
    <!--单据-->
    <el-table :data="list" border style="width: 100%" v-loading="listLoading" ref="dataTable"
      ...
      <el-table-column prop="billDate" label="出库日期" align="center">
      </el-table-column>
    </el-table>
    ...
    <!-- 新增盘亏出库弹窗 -->
    <check_stock_loss_form :dialogFormVisible="dialogFormVisible" v-if="dialogFormVisible" :id="id"
                           @submitSuccess="submitSuccess" @handleClose="handleClose">
    </check_stock_loss_form>

    <!-- 盘亏出库详情弹窗 -->
    <check_stock_loss_view :dialogFormVisible="dialogDetailVisible" v-if="dialogDetailVisible" :id="id"
                           @submitDetailSuccess="submitDetailSuccess" @handleClose="handleDetailClose">
    </check_stock_loss_view>
  </div>
</template>
...
<script>
  ...
  export default {
    name: "checkStockLoss",
    components: {
      'check_stock_loss_form': () => import('./check_stock_loss_form'),
      'check_stock_loss_view': () => import('./check_stock_loss_view')
    },
    data() {
      return {
    ...
    methods: {
      handleDownload() {
        ...
        import('@/vendor/Export2Excel').then(excel => {
          ...
          if (this.choose == false) {
            tHeader = ['出库日期', '单据编号', '制单人', '出库仓库', '单据状态', '打印次数'];
            ...
            tHeader = ['出库日期', '单据编号', '制单人', '出库仓库', '出库仓位', '商品编码', '商品名称', '单位', '出库数量', '打印次数'];
            filterVal = ['billDate', 'billNo', 'crtUserName', 'warehouseName', 'positionName', 'skuNo', 'skuName', 'unit', 'qty', 'printCount'];
          }
          excel.export_json_to_excel2(tHeader, list, filterVal, '盘亏出库单');
      ...
      handleReset() {
        ...
        this.listQuery.positionName = undefined;
