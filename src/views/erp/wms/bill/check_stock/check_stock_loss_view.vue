<template>
  <el-dialog :visible.sync="dialogFormVisible" width="70%" @close="handleClose" class="billFormDialog billDetailDialog"
    ...
    <el-table :data="items" border highlight-current-row width="100%" :height="clientHeight"
      ...
      <el-table-column prop="skuName" label="商品名称" min-width="250">
        <template slot-scope="scope">
      ...
      <el-table-column prop="retailPrice" label="单价" width="250">
        <template slot-scope="scope">
      ...
      <el-table-column prop="allocationPrice;" label="平均调拨价" width="250">
        <template slot-scope="scope">
      ...
      <el-table-column prop="qty" label="出库数量" width="150" align="right">
        <template slot-scope="scope">
          <span>{{scope.row.qty}}</span>
        </template>
      </el-table-column>
...
<script>
  ...
  import {addBill, getBill, tempAddBill, auditBill} from '@/api/erp/wms/bill/checkStockLoss';
  import {getProcessId} from '@/api/erp/oa/task/taskBill';

  export default {
    name: "checkStockLossView",
