<template>
  <el-dialog :visible.sync="dialogFormVisible" width="70%" @close="handleClose" class="billFormDialog billDetailDialog"
    ...
    <el-table :data="items" border highlight-current-row width="100%" :height="clientHeight"
      ...
      <el-table-column prop="qty" label="入库数量" width="150" align="right" class-name="col-required">
        <template slot-scope="scope">
...
<script>
  ...
  import {addBill, getBill, tempAddBill, auditBill} from '@/api/erp/wms/bill/checkStockProfit';
  import {getProcessId} from '@/api/erp/oa/task/taskBill';

  export default {
    name: "checkStockProfitView",
