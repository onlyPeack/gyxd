<template>
  <div class="full-purchase bill-container">
    ...
    <el-table :data="list" border style="width: 100%" v-loading="listLoading" ref="dataTable"
      ...
      <el-table-column prop="mainDTO.customerName" label="订货单位" width="200">
      </el-table-column>
      <el-table-column prop="mainDTO.supplierName" label="供应商名称" width="250">
      </el-table-column>
      ...
      <el-table-column prop="specifications" label="规格型号" min-width="180" align="center">
      </el-table-column>
      <el-table-column prop="mainDTO.sourceBillNo" label="关联单据编号" align="center" width="150">
      </el-table-column>
      <el-table-column prop="qty" label="数量" align="right" width="80">
      </el-table-column>
      <el-table-column prop="taxPrice" label="含税单价" align="right" width="120">
      </el-table-column>
      <el-table-column prop="taxAmount" label="价税合计" align="right" width="120" class-name="col-required" sortable>
      </el-table-column>
      <el-table-column prop="saleCostAmount" label="成本金额" align="right" width="120"
                       class-name="col-required"></el-table-column>
      <el-table-column prop="saleProfit" label="销售利润" align="right" width="120" class-name="col-required"
                       sortable></el-table-column>
      <el-table-column prop="saleInvoiceQty" label="开票数量" width="80" align="right"></el-table-column>
    ...
    <el-table :data="list" border style="width: 100%" v-loading="listLoading" ref="dataTable"
      ...
      <el-table-column prop="taxBillAmount" label="价税合计" align="right" width="120" class-name="col-required" sortable>
      </el-table-column>
      <el-table-column prop="sumSaleProfit" label="销售利润" align="right" width="120" class-name="col-required" sortable>
      </el-table-column>
      <el-table-column prop="sourceBillNo" label="关联单据编号" align="center" width="150">
      </el-table-column>
    ...
    <!-- 新增直发出库弹窗 -->
    <straight_stock_out_form :dialogFormVisible="dialogFormVisible" v-if="dialogFormVisible" :id="id"
                             @submitSuccess="submitSuccess" @handleClose="handleClose">
    </straight_stock_out_form>

    <!-- 直发出库详情弹窗 -->
    <straight_stock_out_detail :dialogFormVisible="dialogDetailVisible" v-if="dialogDetailVisible" :id="id"
                               @submitDetailSuccess="submitDetailSuccess" @handleClose="handleDetailClose">
    </straight_stock_out_detail>
  </div>
</template>

<script>
  import { batchDelBill, selectPage, selectPageByItem } from '@/api/erp/wms/bill/straightStockOut'
  import { getFloat } from '@/utils/util'

  export default {
    name: 'straightStockOut',
    components: {
      'straight_stock_out_form': () => import('./straight_stock_out_form'),
      'straight_stock_out_detail': () => import('./straight_stock_out_view')
    },
    data() {
      return {
