<template>
  <el-dialog :visible.sync="dialogFormVisible" width="70%" @close="handleClose"
          ...
          <tr>
            ...
            <td>
              <el-form-item label="配送方式:" prop="transportType" class="el-form-flex">
                <div v-for="item in transportTypeOptions">
                  <span v-if="dataForm.transportType==item.value">{{item.label}}</span>
                </div>
              </el-form-item>
            </td>
          </tr>
          <tr>
            <td>
              <el-form-item label="是否代发货:" prop="isReplaceDelivery" class="el-form-flex">
                {{dataForm.isReplaceDelivery == '1' || dataForm.isReplaceDelivery == 1?'是':'否'}}
              </el-form-item>
            </td>
            <td>
              <el-form-item v-if="dataForm.isReplaceDelivery == '1' || dataForm.isReplaceDelivery == 1" label="发货人:" prop="deliverName" class="el-form-flex">
                {{dataForm.deliverName}}
              </el-form-item>
            </td>
          </tr>
          <tr  v-if="dataForm.isReplaceDelivery == '1' || dataForm.isReplaceDelivery == 1" >
            <td>
              <el-form-item label="发货电话:" prop="deliverPhone" class="el-form-flex"> {{dataForm.deliverPhone}}</el-form-item>
            </td>
            <td>
              <el-form-item label="发货公司:" prop="deliverCompany" class="el-form-flex">{{dataForm.deliverCompany}} </el-form-item>
            </td>
          </tr>
          <tr>
            <td>
    ...
    <el-table :data="items" border highlight-current-row width="100%" :height="clientHeight"
      ...
      <el-table-column prop="stockReturnQty" label="退款数量" width="100" align="right" class-name="col-required">
        <template slot-scope="scope">
          <span>{{scope.row.stockReturnQty}}</span>
        </template>
      </el-table-column>
