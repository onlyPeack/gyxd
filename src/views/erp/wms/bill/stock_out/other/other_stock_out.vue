<template>
  <div class="full-purchase bill-container">
    ...
    <!-- 新增合同弹窗 -->
    <other_stock_out_form :dialogFormVisible="dialogFormVisible" v-if="dialogFormVisible" :billNo="billNo"
                                @submitSuccess="submitSuccess" @handleClose="handleClose">
    </other_stock_out_form>
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    components: {
      'other_stock_out_form': () => import('./other_stock_out_form')
    },
    data() {
      return {
        list: [],
