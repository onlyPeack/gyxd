<template>
  <div class="app-container calendar-list-container customer-type-container">
    <div class="filter-container">
      <el-input @keyup.enter.native="handleFilter" style="width: 200px;" class="filter-item" placeholder="客户属性名称"
    ...
    <el-table size="small" :data="list" v-loading="listLoading" element-loading-text="正在查询中。。。" border fit
      ...
      <el-table-column align="center" label="客户属性名称" prop="name"></el-table-column>
          ...
          .then(response => {
            if (response.data.records) {
              for (const i in response.data.records) {
                response.data.records[i].isSwitch = response.data.records[i].status != '0';
              }
            }
