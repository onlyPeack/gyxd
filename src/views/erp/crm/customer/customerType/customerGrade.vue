<template>
  <div class="app-container calendar-list-container customer-grade-container">
    <div class="filter-container">

      <el-input @keyup.enter.native="handleFilter" style="width: 200px;" class="filter-item" placeholder="等级名称"
    ...
    <el-table size="small" :data="list" v-loading="listLoading" element-loading-text="正在查询中。。。" border fit
      ...
      <el-table-column align="center" label="是否默认" prop="isDefault">
        <template slot-scope="scope">
          <div v-for="item in isDefaultOptions">
            <span v-if="scope.row.isDefault ===item.value">{{item.label}}</span>
          </div>
        </template>
      </el-table-column>
      <el-table-column align="center" label="状态" prop="phone">
        <template slot-scope="scope">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible" class="ms-dialog">
      <el-form :model="form" :rules="rules" ref="form">
        <table class="topTable">
          <tr>
            <td colspan="2">
              <el-form-item label="等级名称:" prop="name" class="el-form-flex">
          ...
          <tr>
            <td width="50%">
              <el-form-item label="排序:" prop="sort" class="el-form-flex">
                <el-input v-model="form.sort" type="number"></el-input>
              </el-form-item>
            </td>
            <td width="50%">
              <el-form-item label="商品价格折扣率:" prop="discount" class="el-form-flex">
          ...
          <tr>
            <td width="50%">
              <el-form-item label="是否默认等级:" prop="isDefault" class="el-form-flex">
                <div style="margin-top: 6px;">
                  <el-radio v-model="form.isDefault" v-for="item in isDefaultOptions" :key="item.value"
                            :label="item.value">
                    {{item.label}}
                  </el-radio>
                </div>
