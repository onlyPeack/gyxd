<template>
  <div class="app-container calendar-list-container customer-visit-container">
    ...
    <el-table size="small" :data="list" v-loading="listLoading" element-loading-text="正在查询中。。。" border fit
      ...
      <el-table-column align="center" label="拜访描述" prop="description"></el-table-column>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible" class="ms-dialog">
      <el-form :model="form" :rules="rules" ref="form">
        <table class="topTable">
          ...
          <tr>
            <td colspan="2">
              <el-form-item label="拜访描述:" prop="description" class="el-form-flex">
...
<script>
  import {
    ...
    delObj,
    putObj
  } from '@/api/erp/crm/customerVisit';
