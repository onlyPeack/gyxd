  ...
  <div class="full-purchase bill-container">
    ...
    <div class="filter-container">
      <div>
        ...
        <el-select v-model="listQuery.source" placeholder="订单来源" clearable style="width: 200px;position:relative;top:-4px;"
                   @change="handleFilter" filterable>
      ...
      <div class="query-container" >
        <div v-if="choose">
          ...
          <el-select  v-if="choose" v-model="listQuery.salesType" placeholder="货物类型" clearable style="width: 200px;"
    ...
    <el-table :data="list" border style="width: 100%" v-loading="listLoading" ref="dataTable"
      ...
      <el-table-column prop="mainDTO.source" label="订单来源" width="80" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column prop="salesType" label="货物类型" width="80" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column prop="mainDTO.customerName" label="客户名称" width="120" :show-overflow-tooltip="true">
      </el-table-column>
      ...
      <el-table-column prop="skuNo" label="商品编码" width="100" align="center">
      </el-table-column>
      <el-table-column prop="unit" label="单位" width="60" align="center">
      </el-table-column>
      <el-table-column prop="mainDTO.taxBillAmount" label="总价税合计" align="right" width="120">
      </el-table-column>
      ...
      <el-table-column prop="orderQty" label="采购订货数量" align="right" width="100">
      </el-table-column>
      <el-table-column prop="applicableFutureQty" label="可采购期货" align="right" width="100">
      </el-table-column>
      <el-table-column prop="applicableSynergyQty" label="可采购调拨" align="right" width="100">
      </el-table-column>
      <el-table-column prop="applicableIdleQty" label="可采购闲置" align="right" width="100">
      </el-table-column>
      <el-table-column prop="purchaseStockInQty" label="采购入库数量" align="right" width="100">
      </el-table-column>
      <!--<el-table-column prop="deliverQty" label="发货数量" align="right" width="120">-->
      <!--</el-table-column>-->
      <el-table-column prop="stockOutSaleQty" label="出库数量" align="right" width="100" class-name="col-required">
      </el-table-column>
      ...
      <el-table-column prop="mainDTO.storageStatus" label="出库状态" width="80" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column prop="purchaseInvoiceQty" label="开票数量" align="right" width="80">
      </el-table-column>
      ...
      <!--      <el-table-column prop="crtUserNo" label="制单人工号" width="100">-->
      <!--      </el-table-column>-->
      <!--      <el-table-column prop="crtUserName" label="制单人姓名" width="100">-->
      <!--      </el-table-column>-->
    ...
    <el-table :data="list" border style="width: 100%" v-loading="listLoading" ref="dataTable"
      ...
      <el-table-column prop="source" label="订单来源" width="100" align="center">
        <template slot-scope="scope">
          <span v-for="item in source">
            <span v-if="scope.row.source ===item.value">{{item.label}}</span>
          </span>
        </template>
      </el-table-column>
...
<!--      </el-table-column>-->
      ...
      <el-table-column prop="billActuallyRebateAmount" label="实付金额" width="120" align="right" class-name="col-required">
      </el-table-column>
      ...
      <el-table-column prop="storageStatus" label="出库状态" width="80" align="center">
        <template slot-scope="scope">
    ...
    <!-- 新增客户订货单弹窗 -->
    <customer-order-form :dialogFormVisible="dialogFormVisible" v-if="dialogFormVisible" :id="id"
...
<script>
  import {selectPage, selectPageByItem, batchDelBill} from '@/api/erp/sales/bill/salesOrder';
  import {getFloat} from '@/utils/util';

  export default {
    name: "salesOrderList",
    components: {
      'customer-order-form': () => import('./customerOrderForm'),
