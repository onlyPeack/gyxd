          ...
          <tr>
            ...
            <td>
              <el-form-item label="单据日期:" prop="billDate" class="el-form-flex">
                <el-input v-model="dataForm.billDate" placeholder="billDate" readonly>
                </el-input>
              </el-form-item>
            </td>
          </tr>
          ...
          <tr>
            <td>
              <el-form-item label="开始时间:" prop="beginTime" class="el-form-flex">
                <el-input v-model="dataForm.beginTime" type="textarea" :rows="2" readonly></el-input>
              </el-form-item>
            </td>
            <td>
              <el-form-item label="结束时间:" prop="endTime" class="el-form-flex">
                <el-input v-model="dataForm.endTime" type="textarea" :rows="2" readonly></el-input>
              </el-form-item>
            </td>
          </tr>
          <tr>
            <td :colspan="2">
              <el-form-item label="备注:" prop="note" class="el-form-flex">
                <el-input v-model="dataForm.note" type="textarea" :rows="2" placeholder="请输入返点系列" readonly></el-input>
              </el-form-item>
            </td>
...
<script>
  ...
  import {getBill,auditBill} from '@/api/erp/purchase/bill/policySeriesRebate';
