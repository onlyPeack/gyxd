          ...
          <tr>
            <td >
              <el-form-item label="采购类型:" prop="type" class="el-form-flex">
                 <span v-for="(item,index) in typeOption" v-if="dataForm.type==typeOption[index].value" :key="index">{{typeOption[index].label}}</span>
              </el-form-item>
            </td>
            <td>
              <el-form-item label="订单类型:" prop="orderType" class="el-form-flex">
                <span v-if="dataForm.orderType == 0">普通订单</span>
                <span v-if="dataForm.orderType == 1">EDI订单</span>
              </el-form-item>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            <td width="50%">
              <el-form-item label="收货人:" prop="factoryName" class="el-form-flex">
                {{dataForm.factoryName}}
              </el-form-item>
            </td>
            <td width="50%">
              <el-form-item label="收货电话:" prop="factoryPhone" class="el-form-flex">
                {{dataForm.factoryPhone}}
              </el-form-item>
            </td>
          </tr>
          <tr>
            ...
            <td>
               <el-form-item label="合同:" prop="fileName" class="el-form-flex" >
                <div style="margin-top:5px;padding:5px">
                  <div v-for="(item,index) in dataForm.attachments" :key="item.fileUrl" style="height:20px;line-height:20px">
                    <span style="display:inline-block;position:relative;top:5px;width: 180px;overflow: hidden;white-space: nowrap;text-overflow: ellipsis;">
                      {{item.fileName}}
                    </span>
    ...
    <div slot="footer" class="dialog-footer">
      ...
      <div v-if="dataForm.billStatus && dataForm.billStatus==4" style="float: left;display: inline-block;">
        ...
        <el-button type="primary">
          <router-link target="_blank" :to="{path:'/print/purchase-order-print',query:{id:id,supplierId:dataForm.supplierId}}">打 印</router-link>
        </el-button>
      </div>
