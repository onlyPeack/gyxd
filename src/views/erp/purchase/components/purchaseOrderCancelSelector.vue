  ...
  <el-dialog title="选择关联单据" :visible.sync="dialogSelectorVisible" width="70%" @close="handleSelectorClose"
    ...
    <div class="full-purchase purchase-order-full-purchase">
      ...
      <el-table :data="list" border style="width: 100%" v-loading="listLoading" ref="dataTable"
        ...
        <el-table-column prop="mainDTO.purchaserName" label="采购员" align="center" width="120">
        </el-table-column>
        ...
        <el-table-column prop="seriesName" label="标准系列" width="150">
        </el-table-column>
...
<script>
  import {selectPageByItem} from '@/api/erp/purchase/bill/purchaseReceiptGoodsNotice';
  import {getFloat} from '@/utils/util';

  export default {
    name: "purchaseOrderCancelSelector",
