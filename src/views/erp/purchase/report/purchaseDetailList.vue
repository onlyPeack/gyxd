<template>
  <div class="app-container calendar-list-container purchase-detail-list-container">
    ...
    <div class="filter-container sales-detail-list-filter-container">
      <div>
        ...
        <div style="float: right;">
          ...
          <el-button class="filter-item" type="primary" icon="el-icon-download" :loading="downloadLoading" @click="handleDownload">导出</el-button>
        </div>
      </div>
      <div>
    ...
    <el-table size="small" :data="list" v-loading="listLoading" element-loading-text="正在查询中。。。" border fit
      ...
      <el-table-column align="right" label="采购员" prop="purchaserName">
      </el-table-column>
    ...
    methods: {
      ...
      handleDownload() {
        ...
        import('@/vendor/Export2Excel').then(excel => {
          const tHeader = ['商品', '供应商', '采购员', '单位', '入库单价', '入库数量', '入库金额', '退库单价', '退库数量', '退库金额'];
          const filterVal = ['skuName', 'supplierName', 'purchaserName', 'unit', 'stockInPurchasePrice', 'stockInPurchaseQty', 'stockInPurchaseAmount', 'returnStockPrice', 'returnStockQty','returnStockAmount'];
          excel.export_json_to_excel2(tHeader, this.list, filterVal, '采购明细');
...
<style lang="scss" scoped>
  .purchase-detail-list-container {
    .el-date-editor{
      position: relative;
      top: -4px;
    }
