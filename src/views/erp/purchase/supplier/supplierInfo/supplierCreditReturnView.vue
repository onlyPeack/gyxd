    ...
    <div class="center-container">
      ...
      <el-form :model="form" :rules="rules" ref="form">
        <table class="topTable">
          ...
          <tr>
            <td width="50%">
              <el-form-item label="供应商编号:" prop="customerCode" class="el-form-flex">
...
<script>
  import {getObj, auditBill} from '@/api/erp/purchase/supplier/supplierCreditReturn';
