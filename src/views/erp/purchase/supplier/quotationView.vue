      ...
      <el-form :model="dataForm" :rules="rules" ref="dataForm">
        <table class="topTable">
          ...
          <tr>
            ...
            <td>
              <el-form-item label="付款条件:" prop="receiptCondition" class="el-form-flex">
...
<script>
  ...
  import {addBill, getBill, tempAddBill, auditBill} from '@/api/erp/purchase/bill/purchaseQuotation';
