<template>
  <el-dialog :visible.sync="dialogFormVisible" width="70%" @close="handleClose"
    ...
    <div class="center-container">
      ...
      <el-form :model="dataForm" :rules="rules" ref="dataForm">
        <table class="topTable">
          ...
          <tr>
            <td>
              <el-form-item label="付款账户:" prop="payAccount" class="el-form-flex" v-if="bankAccountArr.length > 0">
                {{bankAccountArr.find(item => item.accountCode == dataForm.payAccount).name }}
              </el-form-item>
            </td>
            <td>
    ...
    <el-table :data="items" border highlight-current-row width="100%" :height="clientHeight"
      ...
      <el-table-column prop="applyAmount" label="应付" align="right" class-name="col-required">
        <template slot-scope="scope">
      ...
      <el-table-column prop="sumOfAdvance" label="冲抵预付金额" align="right" class-name="col-required">
        <template slot-scope="scope">
...
<script>
  ...
  import {addBill, getBill, tempAddBill, auditBill} from '@/api/erp/purchase/bill/purchasePayment';
