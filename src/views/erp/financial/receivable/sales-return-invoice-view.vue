<template>
  <el-dialog :visible.sync="dialogFormVisible" width="70%" @close="handleClose"
    ...
    <div class="center-container">
      <el-form :model="dataForm" :rules="rules" ref="dataForm">
        <table class="topTable">
          ...
          <tr>
            <td >
              <el-form-item label="退票类型:" prop="note" class="el-form-flex">
                <span v-if="dataForm.refundType*1===0">退货退票</span>
                <span v-else-if="dataForm.refundType*1===1">退票重开</span>
              </el-form-item>
            </td>
            <td>
    ...
    <el-table :data="items" border highlight-current-row width="100%" :height="clientHeight"
      ...
      <el-table-column prop="specifications" label="品牌" width="180">
        <template slot-scope="scope">
      ...
      </el-table-column><el-table-column prop="specifications" label="规格型号" width="180">
      <template slot-scope="scope">
      ...
      <el-table-column prop="qty" label="退票数量" width="100" class-name="col-required" align="right">
        <template slot-scope="scope">
...
<script>
  ...
  import {addBill, getBill, tempAddBill, auditBill} from '@/api/erp/financial/financialSalesReturnInvoice'
  import {getProcessId} from '@/api/erp/oa/task/taskBill';

  export default {
    name: "sales-return-invoice-view",
