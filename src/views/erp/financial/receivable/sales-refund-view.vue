...
<!--      <div class="association-creation">关联创建</div>-->
    ...
    <el-table :data="items" border highlight-current-row width="100%" :height="clientHeight"
      ...
      <el-table-column prop="bankName" label="客户银行" min-width="120" class-name="col-required"></el-table-column>
      <el-table-column prop="bankAccount" label="客户银行账号" min-width="180" class-name="col-required"></el-table-column>
      <el-table-column prop="receiveDate" label="退款日期"></el-table-column>
...
<script>
  ...
  import {addBill, getBill, tempAddBill, auditBill} from '@/api/erp/financial/salesRefund';
