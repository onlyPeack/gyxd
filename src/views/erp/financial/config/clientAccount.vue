<template>
  <div class="app-container calendar-list-container sales-summary-list-container bill-container">
    <el-tabs v-model="selectType">
      <el-tab-pane label="客户资金账户" name="1">
        <!-- 查询和其他操作 -->
        <div class="filter-container client-account-filter-container">
          <div>
        ...
        <el-table size="small" :data="list" v-loading="listLoading" element-loading-text="正在查询中。。。" border fit
          ...
          <el-table-column align="left" label="客户名称" prop="accountName" sortable width="240" show-overflow-tooltip>
          </el-table-column>
      ...
      <el-tab-pane label="客户交易记录" name="2">
        ...
        <div class="filter-container client-account-filter-container">
          <div>
            ...
            <el-input clearable class="filter-item" style="width: 180px;" placeholder="客户名称"
        ...
        <el-table size="small" :data="flowList" v-loading="listLoading" element-loading-text="正在查询中。。。" border fit
          ...
          <el-table-column align="left" label="客户名称" prop="accountName" sortable width="240">
          </el-table-column>
          <el-table-column align="left" label="业务员" prop="salerNo" sortable>
          </el-table-column>
          <el-table-column align="left" label="所属部门" prop="departName" sortable>
          ...
          <!--</el-table-column>-->
          <el-table-column align="left" label="交易时间" prop="crtTime" sortable width="150">
          </el-table-column>
          ...
          <el-table-column align="left" label="说明" prop="tradeDesc" width="270">
          </el-table-column>
          <el-table-column align="left" label="备注" prop="note">
          </el-table-column>
        </el-table>
      ...
      handleDownload() {
        ...
        import('@/vendor/Export2Excel').then(excel => {
          ...
          if (this.selectType == '1') {
            tHeader = ['账户号', '客户名称', '业务员', '所属部门', '账户总金额', '冻结金额', '可用余额', '授信金额', '账户状态', '创建时间', '最后更新时间', '备注'];
            ...
            tHeader = ['单据编号', '账户号', '客户名称', '业务员', '所属部门', '交易时间', '交易名称', '收支金额', '交易后可用余额', '来源', '说明', '备注'];
            ...
            excel.export_json_to_excel2(tHeader, list, filterVal, '客户交易记录');
          }
          this.downloadLoading = false;
        })
      },
      changeDivHeight() {
        if (document.getElementsByClassName('client-account-filter-container')[0]) {
          if (this.selectType == '1') {
            var height = document.getElementsByClassName('client-account-filter-container')[0].clientHeight;
          } else {
            var height = document.getElementsByClassName('client-account-filter-container')[1].clientHeight;
          }
        } else {
          height = 48;
        }
      ...
      getSummaries(param) {
        ...
        columns.forEach((column, index) => {
          ...
          if (!values.every(value => isNaN(value))) {
            if (column.property == 'amount' || column.property == 'frozenAmount' || column.property == 'availableAmount' || column.property == 'creditAmount') {
