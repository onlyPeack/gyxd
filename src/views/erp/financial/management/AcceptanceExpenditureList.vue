  ...
  <div class="full-purchase bill-container">
    ...
    <el-table :data="list" border style="width: 100%" v-loading="listLoading" ref="dataTable"
      ...
      <el-table-column prop="paymentAmt" label="本次支出金额" min-width="120" align="right" class-name="col-required">
        <template slot-scope="scope">
          {{Number(scope.row.paymentAmt).toFixed(4)}}
        </template>
      </el-table-column>
      ...
      <el-table-column prop="customerCode" label="原到款客户" width="120" align="center">
      </el-table-column>
      <el-table-column prop="toBankCode" label="原到款银行" align="center" width="120">
      </el-table-column>
      ...
      <el-table-column prop="crtUserName" label="制单人"  align="center" width="140">
      </el-table-column>
    ...
    <el-table :data="list" border style="width: 100%" v-loading="listLoading" ref="dataTable"
      ...
      <el-table-column prop="expenditureType" label="支出类型"  align="center">
      </el-table-column>
      <el-table-column prop="crtUserNo" label="制单人工号" width="120" align="center">
      </el-table-column>
    ...
    <!-- 新增承兑支出单弹窗 -->
    <acceptance-expenditure-form :dialogFormVisible="dialogFormVisible" v-if="dialogFormVisible" :id="id"
    @submitSuccess="submitSuccess" @handleClose="handleClose" :typeOptions="typeOptions">
    </acceptance-expenditure-form>
...
<script>
  ...
  export default {
    name: "AcceptanceExpenditureList",
    data() {
      return {
        list: [],
        total: undefined,
    ...
    components: {
      'acceptance-expenditure-form':  () => import( './AcceptanceExpenditureForm.vue'),
      'acceptance-expenditure-view':  () => import( './AcceptanceExpenditureView.vue'),
    },
    created() {
