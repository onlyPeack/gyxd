...
<script>
  import {pageCompanyAccount} from '@/api/erp/financial/financialCapitalAccount';
  ...
  export default {
    ...
    methods: {
      getList() {
        ...
        pageCompanyAccount(this.listQuery)
          .then(response => {
      ...
      onSubmit() {
        this.$emit('closeExpenseAccountDialog', this.currentAccount)
      },
