<template>
  <div class="detail-container">
        ...
        <div class="form-container-border">
          ...
          <el-row>
            ...
            <el-col class="form-border font-small" :span="18" style="height:50px">
              ...
              <el-button type="text" size="small" @click="handleViewOrder(orderReturnApply.orderId)">查看</el-button>
            </el-col>
          </el-row>
          <el-row>
    ...
    <order-detail :id="orderId" :visible="orderDetailDialogVisible" @handleClose="orderDetailHandleClose"></order-detail>
  </div>
</template>
<script>
  import {getApplyDetail,updateApplyStatus} from '@/api/erp/mall/oms/apply/apply';
  import {selectPage as getCompanyAddressList} from '@/api/erp/mall/oms/order/companyAddress';
  import {formatDate} from '@/utils/date';
  import OrderDetail from '@/views/erp/mall/oms/order/orderDetail';
