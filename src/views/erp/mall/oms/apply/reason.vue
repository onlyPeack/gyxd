<template> 
  <div class="app-container">
    ...
    <div class="table-container">
      <el-table ref="returnReasonTable" :data="list" style="width: 100%;"
...
<script>
  ...
  import {selectPage,deleteReason,updateStatus,addReason,getReasonDetail,updateReason} from '@/api/erp/mall/oms/apply/reason';
