    ...
    <div class="center-container">
      ...
      <el-form :model="dataForm" :rules="rules" ref="dataForm">
        <table class="topTable">
          <tr>
            <td colspan="2">
              <el-form-item label="单据状态:" prop="billDate" class="el-form-flex">
              <template slot-scope="scope">
                <div v-for="item in statusOptions" v-if="dataForm">
                  <span v-if="item.value==dataForm.billStatus">{{item.label}}</span>
                </div>
              </template>
              </el-form-item>
            </td>
          ...
          <tr>
            <td width="50%">
              <el-form-item label="单据编号:" prop="billDate" class="el-form-flex">
                {{dataForm.billNo}}
              </el-form-item>
            </td>
            <td width="50%">
              <el-form-item label="订单编号:" prop="sourceBillNo" class="el-form-flex">
                {{dataForm.orderSn}}
              </el-form-item>
            </td>
          </tr>
          <tr>
            <td  width="50%">
              <el-form-item label="延时发货天数:" prop="customerName" class="el-form-flex">
                {{dataForm.delayedDays}}
              </el-form-item>
            </td>
            <td  width="50%">
              <el-form-item label="延时发货原因:" prop="warehouseName" class="el-form-flex">
                {{dataForm.delayedReason}}
              </el-form-item>
            </td>
          </tr>
        </table>
...
<script>
  ...
  import {addBill, getObj, tempAddBill, auditBill} from '@/api/erp/mall/oms/order/orderDelayed';
