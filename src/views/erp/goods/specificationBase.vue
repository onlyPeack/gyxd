<template>
  <div class="app-container calendar-list-container">
    ...
    <div class="filter-container">
      <el-input clearable class="filter-item" style="width: 200px;" placeholder="请输入规格名称"
    ...
    <el-table size="small" :data="list" v-loading="listLoading" element-loading-text="正在查询中。。。" border fit
      ...
      <el-table-column align="center" label="规格值" prop="stringList">
      </el-table-column>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible" width="700px">
      <el-form :rules="rules" ref="dataForm" :model="dataForm" status-icon label-position="left" label-width="100px"
        ...
        <!--el-row>
          <el-col :span="24">
            <el-form-item label="排序" prop="sort">
              <el-input v-model="dataForm.sort" placeholder="请输入规格排序"></el-input>
            </el-form-item>
          </el-col>
        </el-row-->
        <el-row>
          <el-col :span="24">
            <el-form-item label="规格名称" prop="name">
              <el-input v-model="dataForm.name" placeholder="请输入规格名称"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-table :data="valueTableData" size="mini" highlight-current-row border
          ...
          <el-table-column prop="name" label="规格值编码">
            <template slot-scope="scope">
        ...
        <!--el-tabs v-model="activeName">
          <el-tab-pane label="规格值" name="value">
            <template>
...
<script>
  import {page, addObj, getObj, delObj, putObj} from '@/api/erp/goods/specificationBase';
