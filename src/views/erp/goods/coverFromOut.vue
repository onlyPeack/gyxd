<template>
  <el-dialog :visible.sync="dialogDataBaseVisible" width="85%" @close="handleDialogClose"  class="goodsFormDialog"
    ...
    <el-row>
      ...
      <el-col :span="20" style='padding-left:10px;'>
        ...
        <div class="filter-container">
          ...
          <el-input  class="filter-item" style="width: 160px;margin-right:20px;" placeholder="请输入产品系列名称"  v-model="listQuery.seriesName" clearable>
          </el-input>
        ...
        <div class="pagination-container disableds" style="margin-top: 10px;">
          ...
          <el-button type="primary" icon="el-icon-download" class="filter-item" @click="leadingOut">
            导出(按分类)
          </el-button>
        </div>
      </el-col>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      leadingOut() {
        console.log(this.breadcrumbList[0].label)
      ...
      dialogTap(){
        ...
        delete query.pageSize;
        delete query.pageNo;
        const loadingInstance = Loading.service({ text: '正在导入请稍后....', spinner: 'el-icon-loading', background: 'rgba(0, 0, 0, 0.7)' });
        coverFromOuts(query).then(res => {
          console.log(res)
          if (res.code === 2000) {
