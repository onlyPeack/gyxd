  ...
  <div class="app-container bill-container">
      ...
      <div style="margin-top: 15px">
        <el-form :inline="true" :model="listQuery" size="small" label-width="140px">
          ...
          <el-form-item label="类型：">
            <el-input v-model="listQuery.type" class="input-width" placeholder="类型"></el-input>
          </el-form-item>
    ...
    <div class="table-container">
      <el-table ref="homeAdvertiseTable"
        ...
        <el-table-column label="请求私钥" align="center">
          <template slot-scope="scope">{{scope.row.reqKey}}</template>
        </el-table-column>
        <el-table-column label="响应私钥" align="center">
          <template slot-scope="scope">{{scope.row.resKey}}</template>
        </el-table-column>
...
<script>
  import {fetchList, createHomeCentre, updateHomeCentre, getHomeCentre} from '@/api/mall/pay/information';
