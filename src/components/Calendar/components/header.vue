<template>
  <div class="full-calendar-header">
    ...
    <div class="header-center">
      <span class="prev-month" @click.stop="goPrev"><svg-icon icon-class="left"></svg-icon></span>
      <span class="title">{{title}}</span>
      <span class="next-month" @click.stop="goNext"><svg-icon icon-class="right"></svg-icon></span>
    </div>
