  ...
  <el-dialog title="选择关联单据" :visible.sync="dialogSelectorVisible" width="70%" @close="handleSelectorClose"
    ...
    <div class="full-purchase purchase-order-full-purchase">
      ...
      <el-table :data="list" border style="width: 100%" v-loading="listLoading" ref="dataTable"
        ...
        <el-table-column prop="customerName" label="授信客户编号" width="150">
        </el-table-column>
        <el-table-column prop="customerName" label="授信客户名称" width="150">
        </el-table-column>
...
<script>
  import {selectPage} from '@/api/erp/crm/creditExtension';
  import {getFloat} from '@/utils/util';

  export default {
    name: "creditExtensionSelector",
