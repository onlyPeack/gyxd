  ...
  <el-row>
    <el-col :span="16">
      <div class="filter-container">
        <el-input style="width: 200px;" class="filter-item" placeholder="客户类型名称" v-model="listQuery.name">
        </el-input>
      ...
      <el-table :key='tableKey' :data="list" ref="dataTable" border fit highlight-current-row
        ...
        <el-table-column align="center" label="客户类型名称" prop="name"></el-table-column>
        <el-table-column align="center" label="简称" prop="abbr"></el-table-column>
      </el-table>
    </el-col>
    <el-col :span="8">已选：
...
<script>
  import {page} from '@/api/erp/crm/customerType';
  ...
  export default {
    ...
    methods: {
      ...
      onSubmit(row) {
        this.$emit('closeCustomerTypeDialog', this.currentObject)
      },
