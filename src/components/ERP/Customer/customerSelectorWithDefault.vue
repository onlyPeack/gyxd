    ...
    <el-row>
      <el-col :span="18">
        <div class="filter-container">
          ...
          <el-input style="width: 200px;" class="filter-item" disabled placeholder="业务员姓名" v-model="listQuery.managerName"
                    @keyup.enter.native="handleFilter">
          </el-input>
          <el-input style="width: 200px;" class="filter-item" disabled placeholder="业务员工号" v-model="listQuery.managerCode"
                    @keyup.enter.native="handleFilter">
          </el-input>
...
<script>
  ...
  export default {
    ...
    created() {
      this.listQuery.managerName = this.$store.getters.name
      this.listQuery.managerCode = this.$store.getters.code  
      this.$nextTick(() => {
        this.getList();
      })
    },
    methods: {
      ...
      handleReset() {
        this.listQuery = {
          page: 1,
          limit: 20,
          managerCode: this.$store.getters.code,
          managerName: this.$store.getters.name
        }
        this.getList();
      }
    }
